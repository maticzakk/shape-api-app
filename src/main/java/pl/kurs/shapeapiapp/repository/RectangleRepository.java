...
public interface RectangleRepository extends JpaRepository<Rectangle, Long> {
    ...
    List<Square> getFilteredRectangles(String type, Double areaFrom,
                                    Double areaTo, Double perimeterFrom, Double perimeterTo, LocalDateTime createdAtFrom,
                                    LocalDateTime createdAtTo, String createdBy, Double heightFrom, Double heightTo, Double widthFrom, Double widthTo);
